...
export default function ComprasTable({reload}){
  ...
  try{
    ...
    const res = await fetch("https://bolivia-imports-backend-pg.fly.dev/api/compras")
  ...
  async function guardarTracking(id){
    ...
    try{
      ...
      await fetch(`https://bolivia-imports-backend-pg.fly.dev/api/compras/${id}/tracking`,{
        method:"PATCH",
        headers:{
